...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'border-border bg-background text-foreground hover:border-border-hover focus:border-primary/60 data-[placeholder]:text-muted-foreground/50 flex h-10 w-full items-center justify-between rounded-lg border px-3 py-2 text-[13px] transition-colors duration-150 focus:outline-none focus-visible:shadow-[0_0_0_3px_hsl(var(--primary)/0.08)]',
      className
    )}
    {...props}
  >
